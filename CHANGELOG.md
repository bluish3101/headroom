...
## [0.32.0](https://github.com/bluish3101/headroom/compare/v0.31.0...v0.32.0) (2026-07-10)


### Features

* add --disable-kompress-fallback to restore legacy PASSTHROUGH fallback ([#1185](https://github.com/bluish3101/headroom/issues/1185)) ([f309244](https://github.com/bluish3101/headroom/commit/f309244a77fc3fbb74c5db0082e7dcbebd6ffe52))
* add Copilot BYOK provider wrapper utilities and CLI support ([#1041](https://github.com/bluish3101/headroom/issues/1041)) ([e67ee2a](https://github.com/bluish3101/headroom/commit/e67ee2af658bce35fb4c71b45a0c5b294d7dcfdc))
* add dashboard agent usage stats ([#814](https://github.com/bluish3101/headroom/issues/814)) ([6d3f39f](https://github.com/bluish3101/headroom/commit/6d3f39f213f4eb2d1c6c814b34e1bf6fe2a5c959))
* add differential network capture harness ([#761](https://github.com/bluish3101/headroom/issues/761)) ([11ab5f8](https://github.com/bluish3101/headroom/commit/11ab5f83a1ccd617a2608349a42feff7f7e72b98))
* add first-class OpenCode support (wrap, learn, mcp install) ([#559](https://github.com/bluish3101/headroom/issues/559)) ([91cd210](https://github.com/bluish3101/headroom/commit/91cd2102d7e9bc5d48a594725ecc9593096996ec))
* add HEADROOM_KEEPALIVE_EXPIRY to keep upstream connections warm ([#1124](https://github.com/bluish3101/headroom/issues/1124)) ([85786b3](https://github.com/bluish3101/headroom/commit/85786b33a3a88b8c905739aa34ccfafa01a89e5d))
* add light mode for dashboard ([#834](https://github.com/bluish3101/headroom/issues/834)) ([c425893](https://github.com/bluish3101/headroom/commit/c425893d123e67c62ee20ff64ae350eb4ea56477))
* add OAuth2 client-credentials upstream-auth proxy extension ([#778](https://github.com/bluish3101/headroom/issues/778)) ([#784](https://github.com/bluish3101/headroom/issues/784)) ([eb2e50f](https://github.com/bluish3101/headroom/commit/eb2e50feb26bacadf8812d6e608a458a990096b9))
* Add support for Mistral Vibe CLI ([#935](https://github.com/bluish3101/headroom/issues/935)) ([0932b8b](https://github.com/bluish3101/headroom/commit/0932b8bef4db9109665382b6d7c079a368f08d52))
* add Vertex AI proxy routing ([#793](https://github.com/bluish3101/headroom/issues/793)) ([3c77e52](https://github.com/bluish3101/headroom/commit/3c77e52ce431210e6045671cf5f7c66c79f90a32))
* **agent-savings:** land coding + general workload personas on main ([#1732](https://github.com/bluish3101/headroom/issues/1732)) ([d8db7da](https://github.com/bluish3101/headroom/commit/d8db7da77e07ca9af12c31f29435f6d1e6227d95))
* **anthropic:** add Claude 5 family pricing & align current rates ([#1767](https://github.com/bluish3101/headroom/issues/1767)) ([e84ca98](https://github.com/bluish3101/headroom/commit/e84ca980cff59f082a9faf38ba39a61b566aa009))
* attribute reread waste to over-compression via marker check ([#901](https://github.com/bluish3101/headroom/issues/901)) ([f928576](https://github.com/bluish3101/headroom/commit/f9285766dda77b116c7834165849264e55339720))
* **azure-foundry:** derive upstream URL from ANTHROPIC_FOUNDRY_RESOURCE ([#1138](https://github.com/bluish3101/headroom/issues/1138)) ([e5031b0](https://github.com/bluish3101/headroom/commit/e5031b01219278620431b5560b247e65f1b08a13))
* **bedrock:** cross-region + Converse compression; bundle proxy binary in images ([#999](https://github.com/bluish3101/headroom/issues/999)) ([0dc2e1c](https://github.com/bluish3101/headroom/commit/0dc2e1cb3f7278332d450644831007316d6ac18c))
* **cache:** attribute prompt-cache misses to TTL lapse vs prefix change ([#1313](https://github.com/bluish3101/headroom/issues/1313)) ([#1343](https://github.com/bluish3101/headroom/issues/1343)) ([4658721](https://github.com/bluish3101/headroom/commit/4658721ea0bae5d0d061d377428d4031b9722d75))
* **cache:** provider-agnostic cache-mode delta + cc-agnostic prefix comparison ([#1868](https://github.com/bluish3101/headroom/issues/1868)) ([7c2f0ea](https://github.com/bluish3101/headroom/commit/7c2f0ea07953beaed45b25bd0fc8c5a34d60cb3f))
* **ccr:** wire retrieve-tool interception into OpenAI Responses handler ([#1898](https://github.com/bluish3101/headroom/issues/1898)) ([62cd307](https://github.com/bluish3101/headroom/commit/62cd3072a2ea9bcd8410e400cab6f678501b5b37))
* **cli:** add headroom doctor setup diagnostics ([#926](https://github.com/bluish3101/headroom/issues/926)) ([e45cf4e](https://github.com/bluish3101/headroom/commit/e45cf4e0618b4de02608f68c502ac4cf1270eb84))
* **cli:** add headroom update command and release banner ([#1088](https://github.com/bluish3101/headroom/issues/1088)) ([26be2c3](https://github.com/bluish3101/headroom/commit/26be2c39cb8a3c23edc08516f01cf91fad33c117))
* **cli:** comprehensive help text, validation, and exception handling improvements ([#640](https://github.com/bluish3101/headroom/issues/640)) ([028efab](https://github.com/bluish3101/headroom/commit/028efabb4e611d77118baefb8ffdd13b0edc4fc5))
* **code:** add Perl support to code-aware compressor ([#1125](https://github.com/bluish3101/headroom/issues/1125)) ([f39858c](https://github.com/bluish3101/headroom/commit/f39858c23325f9f27b47a738731e7260f7b59d9e))
* compression extraction — Rust knob exposure, CCR hardening, traffic audits ([#818](https://github.com/bluish3101/headroom/issues/818)) ([b7be381](https://github.com/bluish3101/headroom/commit/b7be3814f1d38375bc27901272bbe919e6b35940))
* compression safety rails — error-output protection, pipeline circuit breaker, library inflation guard ([#851](https://github.com/bluish3101/headroom/issues/851)) ([c0cadcc](https://github.com/bluish3101/headroom/commit/c0cadccff98e572f126185f371e4de9e241b12e0))
* **compression:** add audit-safe mode with protected pattern matching ([#1899](https://github.com/bluish3101/headroom/issues/1899)) ([bb112dd](https://github.com/bluish3101/headroom/commit/bb112dd1762bf744a05689d54c50aed28265ee90))
* **content-router:** accept any real compression (remove min-savings floor) ([#1771](https://github.com/bluish3101/headroom/issues/1771)) ([6c31db9](https://github.com/bluish3101/headroom/commit/6c31db97fbd68f88c39a71785335fc8917702fc3))
* **content-router:** lossless-excluded compaction (grep/log/json) + enable in coding/general personas ([#1762](https://github.com/bluish3101/headroom/issues/1762)) ([f067040](https://github.com/bluish3101/headroom/commit/f0670404ce21b93ab2ca3d1f93e2fad183562335))
* **content-router:** lossless-first dispatch, cross-turn dedup, and A7 lossy-after-fold ([#1818](https://github.com/bluish3101/headroom/issues/1818)) ([60af15f](https://github.com/bluish3101/headroom/commit/60af15f96f1792ad50bf259a765ee188db73d1aa))
* **dashboard:** per-model savings breakdown and expected-vs-actual cost on historical charts ([#807](https://github.com/bluish3101/headroom/issues/807)) ([34dafe6](https://github.com/bluish3101/headroom/commit/34dafe69d907c9a2971abc0d801ff9bfa498b3a8))
* **dashboard:** surface compression-vs-cache net impact in Prefix Cache panel ([#913](https://github.com/bluish3101/headroom/issues/913)) ([2a4d300](https://github.com/bluish3101/headroom/commit/2a4d300841c8cbb55435f821fc2d01c3b3b43a59))
* detect re-served tool results as over-compression waste signal ([#854](https://github.com/bluish3101/headroom/issues/854)) ([5f1d88a](https://github.com/bluish3101/headroom/commit/5f1d88ad2701ed186df93d8e2a3980f0329d9dbb))
* **evals:** add zero-cost tool schema compaction integrity eval ([#817](https://github.com/bluish3101/headroom/issues/817)) ([53a08c6](https://github.com/bluish3101/headroom/commit/53a08c63bf56a76d4fb7b649e37c8e62b0b4cebf))
* **evals:** adversarial-input robustness grid for compressors ([#918](https://github.com/bluish3101/headroom/issues/918)) ([5939004](https://github.com/bluish3101/headroom/commit/5939004185a1f9b4ef2e88ee3e72a10e5c8fa4a6))
* gated Markdown-KV compaction formatter (serialization-aware output) ([#859](https://github.com/bluish3101/headroom/issues/859)) ([06b2625](https://github.com/bluish3101/headroom/commit/06b2625b17b0b032f688d321c6aa30ae3f2b7d96))
* headroom wrap opencode / unwrap opencode CLI ([#1105](https://github.com/bluish3101/headroom/issues/1105)) ([b4571cc](https://github.com/bluish3101/headroom/commit/b4571cc346f6bba29e600fa82bbf5cf302e8ea27))
* **kompress:** warn on unrecognized HEADROOM_KOMPRESS_BACKEND + document backend selection ([#204](https://github.com/bluish3101/headroom/issues/204)) ([6367d0b](https://github.com/bluish3101/headroom/commit/6367d0b7228f53b29bbd20f55c1729476ba5ea68))
* **learn:** weight loops in Headroom Learn + RTK-loop eval ([#1160](https://github.com/bluish3101/headroom/issues/1160)) ([14e8dc4](https://github.com/bluish3101/headroom/commit/14e8dc4c8408b8014433ba7589bbb1dff7805134))
* **learn:** write per-project learnings to CLAUDE.local.md by default ([#1115](https://github.com/bluish3101/headroom/issues/1115)) ([ced75e4](https://github.com/bluish3101/headroom/commit/ced75e4718b5fd84d07cbd68273dcf9b9ef878a3))
* measure and surface token throughput (tokens/sec) through the proxy ([#983](https://github.com/bluish3101/headroom/issues/983)) ([0d89c67](https://github.com/bluish3101/headroom/commit/0d89c674cd3522c0a46e3df9b98426e59b337b10))
* **memory:** add opt-in Apple-GPU (MPS) embedding runtime ([#766](https://github.com/bluish3101/headroom/issues/766)) ([c71592d](https://github.com/bluish3101/headroom/commit/c71592d4214adf1022e4c608518ae0c3ac4aa5e9))
* net-cost cache mutation formula on CompressionPolicy ([#856](https://github.com/bluish3101/headroom/issues/856) P1) ([#857](https://github.com/bluish3101/headroom/issues/857)) ([d5f5802](https://github.com/bluish3101/headroom/commit/d5f58026e2a882bc508acfbddfc9d472100d6e16))
* output-token reduction — verbosity shaper, per-user learning, counterfactual savings ([#965](https://github.com/bluish3101/headroom/issues/965)) ([a99dc61](https://github.com/bluish3101/headroom/commit/a99dc61424df4c7b22c37986fb8dfc648f3ac3b8))
* **parser:** detect re-issued identical tool calls as reread waste ([#909](https://github.com/bluish3101/headroom/issues/909)) ([7d4ae86](https://github.com/bluish3101/headroom/commit/7d4ae86ec0bb09efff765422b89db587b050cd08))
* **plugins:** Hermes agent headroom_retrieve plugin ([#824](https://github.com/bluish3101/headroom/issues/824)) ([058bced](https://github.com/bluish3101/headroom/commit/058bcedab838f3b34ac8e38853e1924329efd820))
* **policy:** batch deep edits through one cache-bust ([#856](https://github.com/bluish3101/headroom/issues/856) P3a) ([#1015](https://github.com/bluish3101/headroom/issues/1015)) ([c2e52fe](https://github.com/bluish3101/headroom/commit/c2e52fe7439b464edaee83827ca7d8c8091d7e9a))
* **policy:** consume net-cost mutation gate in ContentRouter ([#856](https://github.com/bluish3101/headroom/issues/856) P2) ([#905](https://github.com/bluish3101/headroom/issues/905)) ([553ade4](https://github.com/bluish3101/headroom/commit/553ade4ec66793c1707df6a95888ca2c1506c0b1))
* **policy:** decay P_alive from idle time near cache TTL ([#856](https://github.com/bluish3101/headroom/issues/856) P3b) ([#1028](https://github.com/bluish3101/headroom/issues/1028)) ([fe4f9ee](https://github.com/bluish3101/headroom/commit/fe4f9ee478f50a84190a2d44de2b9fbf24272acf))
* probe-based retention scoring of recorded compression events ([#862](https://github.com/bluish3101/headroom/issues/862)) ([c2106cb](https://github.com/bluish3101/headroom/commit/c2106cbdabb905e1980c6694000c220a5042171c))
* **providers:** add Cortex Code (Snowflake CoCo) as a supported agent ([#1190](https://github.com/bluish3101/headroom/issues/1190)) ([d9d0bf4](https://github.com/bluish3101/headroom/commit/d9d0bf4b79f57ce760f4ac236afe19721727d936))
* **proxy:** add --lossless no-CCR mode with format-native compaction ([#1721](https://github.com/bluish3101/headroom/issues/1721)) ([c75ebde](https://github.com/bluish3101/headroom/commit/c75ebdee6df9b1689a44ef321e36e8b360406ed7))
* **proxy:** add CLI opt-outs for CCR injection (compression-only mode) ([#823](https://github.com/bluish3101/headroom/issues/823)) ([693d9d2](https://github.com/bluish3101/headroom/commit/693d9d20e2b2d9bfce3a0c48314850ee77ff8af3))
* **proxy:** add provider-only HTTP proxy ([#1807](https://github.com/bluish3101/headroom/issues/1807)) ([ebe0a3b](https://github.com/bluish3101/headroom/commit/ebe0a3bd7bbc8bbe4ee52bdb1ed7420a405dc224))
* **proxy:** add request timeout config ([#738](https://github.com/bluish3101/headroom/issues/738)) ([c0745d4](https://github.com/bluish3101/headroom/commit/c0745d4161d19e21ca36506f7733f0776e19e1a8))
* **proxy:** add turn-hook extension point for buffered model turns ([#1891](https://github.com/bluish3101/headroom/issues/1891)) ([ec950f7](https://github.com/bluish3101/headroom/commit/ec950f7ef131fb124b60a8e75bc6af7ab733cc7f))
* **proxy:** attribute savings history rollups per provider ([#791](https://github.com/bluish3101/headroom/issues/791)) ([0b8b8d9](https://github.com/bluish3101/headroom/commit/0b8b8d92de3bd5e0301eadedacfb4b1d20a8de7f))
* **proxy:** cc-switch reconciler — keep Headroom in the request path alongside cc-switch ([#1030](https://github.com/bluish3101/headroom/issues/1030)) ([e8fc8a0](https://github.com/bluish3101/headroom/commit/e8fc8a0d18a551bad572ec21aa92a424748683a5))
* **proxy:** compress AWS Bedrock InvokeModel requests via configurable upstream ([#720](https://github.com/bluish3101/headroom/issues/720)) ([7edb27a](https://github.com/bluish3101/headroom/commit/7edb27ab2496b070cbe835b31eb2f828798ddfaa))
* **proxy:** hot-reload live env knobs so a reused proxy picks them up without a restart ([#1090](https://github.com/bluish3101/headroom/issues/1090)) ([6904d47](https://github.com/bluish3101/headroom/commit/6904d47a01e7be496e21d8ebcf34739db5c3b7dd))
* **proxy:** log compressed messages alongside original request ([#261](https://github.com/bluish3101/headroom/issues/261)) ([2269e40](https://github.com/bluish3101/headroom/commit/2269e40bde7e1b9fb0620bd2cec9e33a92834080))
* **proxy:** make COMPRESSION_TIMEOUT_SECONDS configurable via env ([#946](https://github.com/bluish3101/headroom/issues/946)) ([#991](https://github.com/bluish3101/headroom/issues/991)) ([addebdb](https://github.com/bluish3101/headroom/commit/addebdb29c3b4a877ed46553d9b0c0a128d62cef))
* **proxy:** per-project savings breakdown on the dashboard (claude, codex, aider, copilot, cursor) ([#803](https://github.com/bluish3101/headroom/issues/803)) ([914a60a](https://github.com/bluish3101/headroom/commit/914a60a2b07caad8488c1e19a5465726b95f83d3))
* **proxy:** pilot hardening — inbound auth, security headers, audit log, air-gap switch ([#1537](https://github.com/bluish3101/headroom/issues/1537)) ([546ab55](https://github.com/bluish3101/headroom/commit/546ab553dc31af91d5ef4cec0589ad6db8e76a1d))
* **proxy:** support glob patterns in exclude_tools ([#870](https://github.com/bluish3101/headroom/issues/870)) ([#1259](https://github.com/bluish3101/headroom/issues/1259)) ([a2159c0](https://github.com/bluish3101/headroom/commit/a2159c0b66a7aa1b7f64057a1c8e3e50f0a43e37))
* **read-maturation:** activity-based hold-back Read maturation (Mechanism B) ([#1068](https://github.com/bluish3101/headroom/issues/1068)) ([723b80c](https://github.com/bluish3101/headroom/commit/723b80c09123f902197b45b3676065d0e9c77af0))
* **savings:** durable savings ledger + headroom savings command ([#1127](https://github.com/bluish3101/headroom/issues/1127)) ([978ffa0](https://github.com/bluish3101/headroom/commit/978ffa0a6ab9da1a75239270e17961530c213b9d))
* ship the coding profile as Headroom's out-of-box default posture ([#1893](https://github.com/bluish3101/headroom/issues/1893)) ([68676da](https://github.com/bluish3101/headroom/commit/68676daa5076286e2992e81a5cd7d583d82a71b9))
* **stats:** surface Codex WS compression counters in /stats summary ([#1680](https://github.com/bluish3101/headroom/issues/1680)) ([2fe19c3](https://github.com/bluish3101/headroom/commit/2fe19c39e40fc350af39f72e1a3bac28f9ce9874))
* support Python 3.14+ via pyo3 abi3 stable ABI ([#516](https://github.com/bluish3101/headroom/issues/516)) ([19eac8e](https://github.com/bluish3101/headroom/commit/19eac8e00dc9e3911f3afe8e8e5dcc9e00346baa))
* switch Kompress default to kompress-v2-base with weight-only int8 ONNX ([#799](https://github.com/bluish3101/headroom/issues/799)) ([74392b2](https://github.com/bluish3101/headroom/commit/74392b238e4f76fa061e673d1415fc7fa2830011))
* **transforms:** adaptive Otsu KEEP/DROP threshold (+ land relevance split on main) ([#1726](https://github.com/bluish3101/headroom/issues/1726)) ([eea667a](https://github.com/bluish3101/headroom/commit/eea667a72019cc98401db9211907f67ddf45e7eb))
* **transforms:** attribute read_lifecycle + smart_crush tags ([#249](https://github.com/bluish3101/headroom/issues/249)) ([8f37426](https://github.com/bluish3101/headroom/commit/8f374263d3971c072b5c977375c873864fb05763))
* **transforms:** tabular + spreadsheet (.xlsx/.xls) compression ([#1128](https://github.com/bluish3101/headroom/issues/1128)) ([d789a7c](https://github.com/bluish3101/headroom/commit/d789a7c528ceee1f4ba648a1002f2e6b6f620854))
* **vertex:** turnkey Claude Code + Vertex compression (+ fixes from the Vertex review) ([#1113](https://github.com/bluish3101/headroom/issues/1113)) ([0e05915](https://github.com/bluish3101/headroom/commit/0e0591506c3f120b96cdc98054114d9ec1771f67))
* **wrap:** add --1m to preserve the 1M context window on wrap claude ([#1158](https://github.com/bluish3101/headroom/issues/1158)) ([#1351](https://github.com/bluish3101/headroom/issues/1351)) ([b50d9c1](https://github.com/bluish3101/headroom/commit/b50d9c17ceca890a0fcc2469b9aff27d0026ca39))
* **wrap:** make tokensave the primary coding-task compressor, Serena the backup ([#1230](https://github.com/bluish3101/headroom/issues/1230)) ([dca9853](https://github.com/bluish3101/headroom/commit/dca9853ed9d09fe1bb6d56fcb7bb82b9e90b7dff))


### Bug Fixes

* **adaptive-sizer:** char bigrams for spaceless CJK items ([#1748](https://github.com/bluish3101/headroom/issues/1748)) ([8879c50](https://github.com/bluish3101/headroom/commit/8879c50dbe929b220b17803a054a078f26b04ca9))
* **agent-evals:** Phase 0 — coding-agent accuracy A/B framework ([#1037](https://github.com/bluish3101/headroom/issues/1037)) ([84f9871](https://github.com/bluish3101/headroom/commit/84f9871e303d587f5b406036b97b9f5a689c1b05))
* **agno:** tolerate streaming tool-call SDK objects in parser ([#1312](https://github.com/bluish3101/headroom/issues/1312)) ([#1336](https://github.com/bluish3101/headroom/issues/1336)) ([5986c22](https://github.com/bluish3101/headroom/commit/5986c2260f07788e356e0884179d9b3f4c0df6e3))
* **anthropic:** CCR exception must re-raise, not silently swallow ([#838](https://github.com/bluish3101/headroom/issues/838)) ([8db5efc](https://github.com/bluish3101/headroom/commit/8db5efc6f9f6de59e9d55cbcd63b75c37a81a26e))
* **anthropic:** strip styled Claude model ids ([#651](https://github.com/bluish3101/headroom/issues/651)) ([0c5c89d](https://github.com/bluish3101/headroom/commit/0c5c89d05cefabaa833e54decfdeb677edacc0d7))
* **anyllm:** forward openai api_base/api_key to the any-llm backend ([#942](https://github.com/bluish3101/headroom/issues/942)) ([#954](https://github.com/bluish3101/headroom/issues/954)) ([a7ee8a6](https://github.com/bluish3101/headroom/commit/a7ee8a60a7ac28a8adcc7a7fa83a04a59afe41d5))
* **bedrock:** add boto3 1.41 + CRT for aws login credentials ([#1486](https://github.com/bluish3101/headroom/issues/1486)) ([4db3bc9](https://github.com/bluish3101/headroom/commit/4db3bc91d9153ca1acccdc0cb5280da01194bf3e))
* **bedrock:** fail fast when session-token auth lacks botocore ([#1553](https://github.com/bluish3101/headroom/issues/1553)) ([54cfa36](https://github.com/bluish3101/headroom/commit/54cfa361d308dec567615c346af7c77d52ebb676))
* **bedrock:** resolve global.* inference profiles + pin per-user app-profile ARNs ([#1795](https://github.com/bluish3101/headroom/issues/1795)) ([33c7f6c](https://github.com/bluish3101/headroom/commit/33c7f6cd3ae14857effcbd110e9cd0668cf1ac1b))
* **bedrock:** route ARNs via converse, named AWS profiles, and au. re… ([#1456](https://github.com/bluish3101/headroom/issues/1456)) ([7d87aa2](https://github.com/bluish3101/headroom/commit/7d87aa2f1cbd93c970a77c6dfec8df03603251b9))
* **build:** enable Intel macOS pip installs via ort-load-dynamic ([#1538](https://github.com/bluish3101/headroom/issues/1538)) ([32ce99e](https://github.com/bluish3101/headroom/commit/32ce99e4b4a7d75f31429a553f2211a83992047a))
* bump codebase-memory-mcp to v0.8.1 ([#1284](https://github.com/bluish3101/headroom/issues/1284)) ([530318b](https://github.com/bluish3101/headroom/commit/530318b425cba8fb161111b135451a838d628e96))
* **cache:** avoid fallback session collisions ([#1827](https://github.com/bluish3101/headroom/issues/1827)) ([0f606b6](https://github.com/bluish3101/headroom/commit/0f606b6281dd4c55e1c5a32cc97c418b66860df1))
* **cache:** guard None exemplar embeddings in dynamic detector ([#950](https://github.com/bluish3101/headroom/issues/950)) ([1ec9320](https://github.com/bluish3101/headroom/commit/1ec93208883f2606cc7ec3db0b8bd8e071646984))
* **cache:** name the missing piece in semantic detector guard ([#1018](https://github.com/bluish3101/headroom/issues/1018)) ([3b0bcee](https://github.com/bluish3101/headroom/commit/3b0bceecf4281eb34112de8dd546d4a58beb3fcc))
* **ccr:** accept 12-char SmartCrusher hashes in tool injection ([#1095](https://github.com/bluish3101/headroom/issues/1095)) ([#1141](https://github.com/bluish3101/headroom/issues/1141)) ([9f7f3ad](https://github.com/bluish3101/headroom/commit/9f7f3adfea03710d5e67c4c630b3c8061ff6d161))
* **ccr:** honor workspace dir for sqlite store ([#1564](https://github.com/bluish3101/headroom/issues/1564)) ([96e1dfe](https://github.com/bluish3101/headroom/commit/96e1dfe395a440f9e2dddf4589c4f6988f4ee4cd))
* **ccr:** key Rust search/diff/log markers with explicit_hash ([#852](https://github.com/bluish3101/headroom/issues/852)) ([bfcb07d](https://github.com/bluish3101/headroom/commit/bfcb07d78ea7eba539a65b11e100ec23b336d8d1))
* **ccr:** make expired retrieve misses terminal ([#1781](https://github.com/bluish3101/headroom/issues/1781)) ([9cbdba4](https://github.com/bluish3101/headroom/commit/9cbdba4dc1f38f73d255211eec439674f3f2f9f1))
* **ccr:** make headroom_retrieve a hash-only full-content lookup ([#1532](https://github.com/bluish3101/headroom/issues/1532)) ([c2fc4d3](https://github.com/bluish3101/headroom/commit/c2fc4d3753c193eb61f78286741431fd1303e8ee))
* **ccr:** make retrieval TTL configurable ([#715](https://github.com/bluish3101/headroom/issues/715)) ([2533f77](https://github.com/bluish3101/headroom/commit/2533f7703ee261dc35767b11e46b8eab6e0c454d))
* **ccr:** preserve Anthropic re-stream shape ([#1854](https://github.com/bluish3101/headroom/issues/1854)) ([f663894](https://github.com/bluish3101/headroom/commit/f663894f6072dbd13f5a1caa05dfea6657f5a3b0))
* **ccr:** preserve thinking blocks in buffered stream re-synthesis ([#1897](https://github.com/bluish3101/headroom/issues/1897)) ([ede085c](https://github.com/bluish3101/headroom/commit/ede085cc11d74778e43ce0fb0828a53a0a06a14b))
* **ccr:** propagate --no-ccr-marker flag to all compressors ([#1022](https://github.com/bluish3101/headroom/issues/1022)) ([#1197](https://github.com/bluish3101/headroom/issues/1197)) ([0c9b42a](https://github.com/bluish3101/headroom/commit/0c9b42a919b0c570094b7934de686b93dd89b05c))
* **ccr:** return stored content when headroom_retrieve query matches nothing ([#1213](https://github.com/bluish3101/headroom/issues/1213)) ([#1236](https://github.com/bluish3101/headroom/issues/1236)) ([08fb845](https://github.com/bluish3101/headroom/commit/08fb845fe37478af2c2f55c402df77d7a448fc86))
* **ccr:** skip Anthropic marker emission when tool injection is deferred ([#1273](https://github.com/bluish3101/headroom/issues/1273)) ([2cae13d](https://github.com/bluish3101/headroom/commit/2cae13dd798b8abdd9ef94fbcf10a968e70e714e))
* **ccr:** skip CCR when model calls headroom_retrieve alongside user tools ([#839](https://github.com/bluish3101/headroom/issues/839)) ([30078f8](https://github.com/bluish3101/headroom/commit/30078f8465fb6bb78a5a9c394b75e60cd3c4eeec))
* **ccr:** use shared compression store ([#875](https://github.com/bluish3101/headroom/issues/875)) ([249af6c](https://github.com/bluish3101/headroom/commit/249af6cc7b379678e60da3e98e552368632fd4f4))
* **ci:** check out repo in PR Governance label job ([#1021](https://github.com/bluish3101/headroom/issues/1021)) ([4558bc2](https://github.com/bluish3101/headroom/commit/4558bc2465e52d575070e5a0d6312cd400c8aee1))
* **ci:** correct comments, timeouts, and pip reliability in native e2e workflows ([#878](https://github.com/bluish3101/headroom/issues/878)) ([b716c8c](https://github.com/bluish3101/headroom/commit/b716c8c2ee7ccc68dd1b9294760db1af866843f2))
* **ci:** extend gitleaks allowlist to cover test fixtures + verified examples ([#1539](https://github.com/bluish3101/headroom/issues/1539)) ([d2565a6](https://github.com/bluish3101/headroom/commit/d2565a6983f99fe6733d412405ee7c9e54d99624))
* **ci:** guarantee model present in test shards to end cache-miss flakiness ([#1399](https://github.com/bluish3101/headroom/issues/1399)) ([2e29c72](https://github.com/bluish3101/headroom/commit/2e29c7223f7a7694060dfe4e1d99332ad766a70b))
* **ci:** make PR governance advisory ([#1047](https://github.com/bluish3101/headroom/issues/1047)) ([74dff94](https://github.com/bluish3101/headroom/commit/74dff94fb8580426f5713991be71df94c4f31598))
* **ci:** normalize Windows CRLF line endings in PR governance script ([#1012](https://github.com/bluish3101/headroom/issues/1012)) ([5194388](https://github.com/bluish3101/headroom/commit/5194388b6652d823ad6ab1d8c17d5572b7f0ec23))
* **ci:** pin cosign-installer to v3 (v4 does not exist) ([#774](https://github.com/bluish3101/headroom/issues/774)) ([199d693](https://github.com/bluish3101/headroom/commit/199d693f98ecd72d80181c8fee8422b6b64651a2))
* **claude:** surface Remote Control proxy incompatibility ([#1610](https://github.com/bluish3101/headroom/issues/1610)) ([4bf7f92](https://github.com/bluish3101/headroom/commit/4bf7f92417a8799ab3ae5f61b7ea9e96c5605a4f))
* **cli/proxy:** preserve explicit HEADROOM_MIN_TOKENS=0 / MAX_ITEMS=0 ([#1886](https://github.com/bluish3101/headroom/issues/1886)) ([3a33af1](https://github.com/bluish3101/headroom/commit/3a33af1af3224594581d0d27ea5b4df1a1c6ba48))
* **cli:** add explicit UTF-8 encoding to file I/O in wrap commands ([#1126](https://github.com/bluish3101/headroom/issues/1126)) ([#1164](https://github.com/bluish3101/headroom/issues/1164)) ([a0cb798](https://github.com/bluish3101/headroom/commit/a0cb7982e3cda52221719b9cceecd4d07e30c176))
* **cli:** fall back gracefully when embedding-server sidecar is absent ([#1206](https://github.com/bluish3101/headroom/issues/1206)) ([38f1404](https://github.com/bluish3101/headroom/commit/38f1404432984915924f74997d886b89c420b2a8))
* **cli:** harden all CLI surfaces + fix docs accuracy ([#1491](https://github.com/bluish3101/headroom/issues/1491)) ([bd76235](https://github.com/bluish3101/headroom/commit/bd76235f5c43bf2e3184a2c7e40a9954dc347afc))
* **cli:** stop advertising unwired compression tuning env vars in banner ([#1634](https://github.com/bluish3101/headroom/issues/1634)) ([d5bf98d](https://github.com/bluish3101/headroom/commit/d5bf98df31528dfd6c23ec45dbd3440efcb1cb75))
* **cli:** wire --http2/--no-http2 (HEADROOM_HTTP2) into proxy command ([#1373](https://github.com/bluish3101/headroom/issues/1373)) ([e06b616](https://github.com/bluish3101/headroom/commit/e06b61671f5cc23832e7d67bce7944e3601a0732))
* **cli:** wire --rpm/--tpm and HEADROOM_RPM/HEADROOM_TPM to the Click proxy command ([#1375](https://github.com/bluish3101/headroom/issues/1375)) ([8aab8f2](https://github.com/bluish3101/headroom/commit/8aab8f22cbd11061484991262d3fee3268e95bfa))
* **code-compressor:** CJK-aware relevance-query symbol matching ([#1747](https://github.com/bluish3101/headroom/issues/1747)) ([b38315c](https://github.com/bluish3101/headroom/commit/b38315cf72e4248cc76cc0e0d10dfa24a4a332e0))
* **code:** parse-probe tree-sitter availability in code_handler ([#1231](https://github.com/bluish3101/headroom/issues/1231)) ([#1300](https://github.com/bluish3101/headroom/issues/1300)) ([1de35e7](https://github.com/bluish3101/headroom/commit/1de35e775f2f19e51258fecddcabc2b88775f7d8))
* **code:** slice tree-sitter byte offsets as UTF-8 ([#1332](https://github.com/bluish3101/headroom/issues/1332)) ([8238402](https://github.com/bluish3101/headroom/commit/82384022bd38304a37e7eade4b5fc98d42f747a8))
* **code:** validate Python compressed syntax ([#1302](https://github.com/bluish3101/headroom/issues/1302)) ([cbd361d](https://github.com/bluish3101/headroom/commit/cbd361de2af266b6d72e246185f622c48ec5a6dc))
* **code:** verify a real parse in tree-sitter availability check ([#1231](https://github.com/bluish3101/headroom/issues/1231)) ([#1299](https://github.com/bluish3101/headroom/issues/1299)) ([5e0bb69](https://github.com/bluish3101/headroom/commit/5e0bb697254b7ec87e3191fa73031bde9321a79c))
* **codex:** avoid duplicate headroom provider config ([#1431](https://github.com/bluish3101/headroom/issues/1431)) ([ddd4adf](https://github.com/bluish3101/headroom/commit/ddd4adf911ee2d7a5323657a771ea0162b5590c4))
* **codex:** compute waste signals on the OpenAI Responses path ([#898](https://github.com/bluish3101/headroom/issues/898)) ([b9e2761](https://github.com/bluish3101/headroom/commit/b9e27614c613a1e5f97eb51af74d3c796fb1ab18))
* **codex:** discover updated Codex state stores ([#1889](https://github.com/bluish3101/headroom/issues/1889)) ([9d42eba](https://github.com/bluish3101/headroom/commit/9d42ebaa1ab6e22e7b1398a3c0618d0d35895f40))
* **codex:** OpenCode Zen telemetry attribution ([#1648](https://github.com/bluish3101/headroom/issues/1648)) ([f18c6bd](https://github.com/bluish3101/headroom/commit/f18c6bd896f7b5a153e3b29f7a27b64c65b08fc5))
* **codex:** poll /wham/usage for subscription limits (handshake no longer sends x-codex-* headers) ([#924](https://github.com/bluish3101/headroom/issues/924)) ([8c00f71](https://github.com/bluish3101/headroom/commit/8c00f7103cf0288991d703cc002ac354e6266534))
* **codex:** PR health label check state ([#986](https://github.com/bluish3101/headroom/issues/986)) ([99c874d](https://github.com/bluish3101/headroom/commit/99c874d4233ec2d35c5c12a709ba32fd2fd96f3d))
* **codex:** respect CODEX_HOME for wrap config ([#731](https://github.com/bluish3101/headroom/issues/731)) ([96abf38](https://github.com/bluish3101/headroom/commit/96abf38b0972adf5e5c66f9a49aa9d9f951b1aa0))
* **codex:** retag thread providers so history menu stays whole across the proxy boundary ([#1034](https://github.com/bluish3101/headroom/issues/1034)) ([74ae781](https://github.com/bluish3101/headroom/commit/74ae7816444ae972b55f3da0ff5e28c8638ab4f3))
* **codex:** retag threads on init so Codex Desktop history stays visible ([#961](https://github.com/bluish3101/headroom/issues/961)) ([#1349](https://github.com/bluish3101/headroom/issues/1349)) ([e6bbc40](https://github.com/bluish3101/headroom/commit/e6bbc40b115bc3b31d68da4dabe280d38e1b691c))
* **codex:** stop pinning Codex memory MCP to one project db ([#1269](https://github.com/bluish3101/headroom/issues/1269)) ([ad7993b](https://github.com/bluish3101/headroom/commit/ad7993bf15e590a7d164407264721ce1b5128b1e))
* **codex:** write canonical hooks feature flag and migrate deprecated codex_hooks ([#743](https://github.com/bluish3101/headroom/issues/743)) ([dff6a19](https://github.com/bluish3101/headroom/commit/dff6a19946b8f96bb8b16fa945b69a1ed09709af))
* **compression:** convert tree-sitter byte offsets to char offsets ([#892](https://github.com/bluish3101/headroom/issues/892)) ([b1f700f](https://github.com/bluish3101/headroom/commit/b1f700fc275bf1d7e9461b61a9ebfdb1fba19620))
* **compression:** correct JSON array item counting and entropy gate ([#887](https://github.com/bluish3101/headroom/issues/887)) ([d6f0f0f](https://github.com/bluish3101/headroom/commit/d6f0f0f64269bfbdf36070cb304703c606c64b72))
* **compression:** keep container bodies compressible in code handler ([#890](https://github.com/bluish3101/headroom/issues/890)) ([16ed73b](https://github.com/bluish3101/headroom/commit/16ed73bca68e602a86a385480d484c3a60025b8c))
* **compression:** measure short-value threshold on payload, not token ([#889](https://github.com/bluish3101/headroom/issues/889)) ([65b0e8c](https://github.com/bluish3101/headroom/commit/65b0e8c58dbbc0b77e4b7159b279287979767c4c))
* **compression:** reject lossy unmarked tool output in unit router path ([#1479](https://github.com/bluish3101/headroom/issues/1479)) ([de24cd5](https://github.com/bluish3101/headroom/commit/de24cd5fc0b894037c0481b5394e6851e87b3993))
* **compression:** use thread-local tree-sitter parsers in code handler ([#893](https://github.com/bluish3101/headroom/issues/893)) ([6cdb846](https://github.com/bluish3101/headroom/commit/6cdb8462000d9610b5d15f6c7c45adb787bfec1e))
* **content_router:** guard against empty compression output causing Anthropic 400 ([#771](https://github.com/bluish3101/headroom/issues/771)) ([2f9ff07](https://github.com/bluish3101/headroom/commit/2f9ff07e6caef0fe32d00ece6266a476eecff5a3))
* **content-detector:** detect and compress space-separated JSON objects ([#1742](https://github.com/bluish3101/headroom/issues/1742)) ([5194bdc](https://github.com/bluish3101/headroom/commit/5194bdc5a6e53d331ce0303aba670e8814bb5fd2))
* **content-router:** honor target_ratio in compression cache + add proxy --target-ratio flag ([#1108](https://github.com/bluish3101/headroom/issues/1108)) ([8894ee0](https://github.com/bluish3101/headroom/commit/8894ee0c18e6dfe858cf0034ec424fd0768a1334))
* **content-router:** token-measure lossless folds at the acceptance gate ([#1772](https://github.com/bluish3101/headroom/issues/1772)) ([c5493ea](https://github.com/bluish3101/headroom/commit/c5493ea93bae798d489a82167c1f7bcff79eaecb))
* **copilot-auth:** stop discarding the caller's valid Copilot auth token ([#1879](https://github.com/bluish3101/headroom/issues/1879)) ([f52ca19](https://github.com/bluish3101/headroom/commit/f52ca19db1c28a87e9c3f6ff4ad21d6a16d7aa08))
* **copilot:** normalize subscription routing host ([#1836](https://github.com/bluish3101/headroom/issues/1836)) ([afd9cbd](https://github.com/bluish3101/headroom/commit/afd9cbdfafba0d31bd376a4a43dbcd41b30ec909))
* **copilot:** route mixed-model requests per model ([#1785](https://github.com/bluish3101/headroom/issues/1785)) ([5af5e22](https://github.com/bluish3101/headroom/commit/5af5e22862a0ce0a3d934c2f1e76ea7c1fad71e7))
* **copilot:** use responses API for subscription reasoning models ([#647](https://github.com/bluish3101/headroom/issues/647)) ([84ac332](https://github.com/bluish3101/headroom/commit/84ac332d14dafacedc2f0b46f5ac6b3977b098d0))
* correct preserved-entry index mapping in Gemini content round-trip ([#836](https://github.com/bluish3101/headroom/issues/836)) ([0ffe2b6](https://github.com/bluish3101/headroom/commit/0ffe2b6ea49e5c8d3bff5fe2c90873c71a95c457))
* **cortex-code:** migrate to current Cortex REST API endpoints + add e2e benchmarks ([#1474](https://github.com/bluish3101/headroom/issues/1474)) ([f00ace6](https://github.com/bluish3101/headroom/commit/f00ace6da57aec2f68b833f42603ba3fda0f9110))
* **dashboard:** align token savings headline denominator ([#1653](https://github.com/bluish3101/headroom/issues/1653)) ([646e705](https://github.com/bluish3101/headroom/commit/646e7055143638ac4a2bc9980649fd046cea7840))
* **dashboard:** deduplicate repeated savings metrics ([#1804](https://github.com/bluish3101/headroom/issues/1804)) ([88f935a](https://github.com/bluish3101/headroom/commit/88f935a1eb52ec81cdd60db44627279d411b74ab))
* **dashboard:** derive per-project setup URL from live origin ([#1511](https://github.com/bluish3101/headroom/issues/1511)) ([e035aef](https://github.com/bluish3101/headroom/commit/e035aefce23fd2e20afccf2659c1db613b05d8ca))
* **dashboard:** distinguish unavailable RTK from zero stats in Docker ([#1900](https://github.com/bluish3101/headroom/issues/1900)) ([87f6e93](https://github.com/bluish3101/headroom/commit/87f6e93c14a9365695142084bc6966d7de70f437))
* **dashboard:** distinguish unavailable RTK from zero stats in Docker ([#1901](https://github.com/bluish3101/headroom/issues/1901)) ([361adcd](https://github.com/bluish3101/headroom/commit/361adcd1a00bbdcb949a3efc7b685937d4e84547))
* **dashboard:** include RTK stats in the historical tab ([#1324](https://github.com/bluish3101/headroom/issues/1324)) ([35939c3](https://github.com/bluish3101/headroom/commit/35939c3536cbaf6e1df01d099943e90ddb364b06))
* **dashboard:** light-mode backgrounds + aligned savings tables ([#1064](https://github.com/bluish3101/headroom/issues/1064)) ([5eae32b](https://github.com/bluish3101/headroom/commit/5eae32ba47fd2e6479cbc1cef1ef4f2fb992fe15))
* **dashboard:** price proxy savings without litellm ([#1728](https://github.com/bluish3101/headroom/issues/1728)) ([188e382](https://github.com/bluish3101/headroom/commit/188e382b44d09d7f16717377f908869292aab4d9))
* **dashboard:** stable 'Proxy $ Saved' hero tile under --workers &gt; 1 ([#481](https://github.com/bluish3101/headroom/issues/481)) ([fd73b88](https://github.com/bluish3101/headroom/commit/fd73b88368b22beeb586b8e1aa37fcd2afb12532))
* **dedup:** shorter fold pointer + MIN_LINES=3, dedup Anthropic list-… ([#1932](https://github.com/bluish3101/headroom/issues/1932)) ([10e4829](https://github.com/bluish3101/headroom/commit/10e4829201b4a66d6e7e8f2f2e8a9d80346de850))
* **deps:** make litellm optional on Python 3.14 ([#956](https://github.com/bluish3101/headroom/issues/956)) ([#993](https://github.com/bluish3101/headroom/issues/993)) ([b2f04e4](https://github.com/bluish3101/headroom/commit/b2f04e4ef714fb6f2776ed95ee9157c34333e6c3))
* **deps:** remediate dependency CVEs and publish SBOM ([#1509](https://github.com/bluish3101/headroom/issues/1509)) ([5771a80](https://github.com/bluish3101/headroom/commit/5771a8020e2666503d87f1298070b44e35aad655))
* detect and clear stale ANTHROPIC_BASE_URL from crashed wrap sessions ([#1768](https://github.com/bluish3101/headroom/issues/1768)) ([#1837](https://github.com/bluish3101/headroom/issues/1837)) ([84509a4](https://github.com/bluish3101/headroom/commit/84509a4b892cc256331106c807a3a56107f1eec2))
* **detection:** contain unidiff panic on orphaned +++ target line ([#1548](https://github.com/bluish3101/headroom/issues/1548)) ([e386c09](https://github.com/bluish3101/headroom/commit/e386c097d6d507aa311ca3a22725b226e9d7b223))
* **docker:** persist headroom workspace in compose ([#1839](https://github.com/bluish3101/headroom/issues/1839)) ([5e29c06](https://github.com/bluish3101/headroom/commit/5e29c06aaf5e3d7d9e591914dc656f24eb72cc07))
* **docker:** persist session history across container revisions ([#1118](https://github.com/bluish3101/headroom/issues/1118)) ([5912d65](https://github.com/bluish3101/headroom/commit/5912d65674c708b00cff9a8cbc3b529fd2ab69fa))
* **docker:** report source build version ([#1862](https://github.com/bluish3101/headroom/issues/1862)) ([3807488](https://github.com/bluish3101/headroom/commit/38074888ac871b8b44418066d66b6a37159978ed))
* don't inject empty tools:[] when client omitted the tools field ([#772](https://github.com/bluish3101/headroom/issues/772)) ([574bbae](https://github.com/bluish3101/headroom/commit/574bbae2cbe2f20b3f0e12b421c25ac256712f0a))
* **e2e:** align Codex wrap e2e with global-only RTK guidance ([#1240](https://github.com/bluish3101/headroom/issues/1240)) ([#1254](https://github.com/bluish3101/headroom/issues/1254)) ([bc12ace](https://github.com/bluish3101/headroom/commit/bc12acef5998f264f22ca6d36b17337791a62e6f))
* emit unknown Anthropic content blocks verbatim in buffered-to-SSE conversion ([#1825](https://github.com/bluish3101/headroom/issues/1825)) ([d05802b](https://github.com/bluish3101/headroom/commit/d05802b6200b94f198e99319e6c778e78b53db8b))
* **evals:** CJK-aware F1 tokenization + token estimation ([#1527](https://github.com/bluish3101/headroom/issues/1527)) ([99a8540](https://github.com/bluish3101/headroom/commit/99a8540e657445df3204f1d15e213262f4289a42))
* **evals:** default unparseable judge scores below pass threshold ([#1892](https://github.com/bluish3101/headroom/issues/1892)) ([42ebbc6](https://github.com/bluish3101/headroom/commit/42ebbc6cce02a0fd5e0a6e614348d47f4099649a))
* **gemini:** offload compression to the executor ([#1382](https://github.com/bluish3101/headroom/issues/1382)) ([615848e](https://github.com/bluish3101/headroom/commit/615848eba408997c1850319028815afadc6c49ed))
* **gemini:** resolve Google model capabilities through ModelRegistry ([#1276](https://github.com/bluish3101/headroom/issues/1276)) ([17ecad9](https://github.com/bluish3101/headroom/commit/17ecad9d89b81313f131d569cfed532f9d42e82a))
* **gemini:** surface functionResponse payloads to waste-signal detection ([#897](https://github.com/bluish3101/headroom/issues/897)) ([9b0c840](https://github.com/bluish3101/headroom/commit/9b0c840dd7c181d6266b31cd16f493393ccc5c1a))
* harden Copilot API auth token handling ([#557](https://github.com/bluish3101/headroom/issues/557)) ([6b0c09f](https://github.com/bluish3101/headroom/commit/6b0c09ffd5f2ce18c4d2cfa6233feaf37d487ead))
* harden persistent install startup ([#1851](https://github.com/bluish3101/headroom/issues/1851)) ([1d2b76e](https://github.com/bluish3101/headroom/commit/1d2b76e72e16eaf532326d9e75a481e18bde1ab7))
* **health:** readyz verifies upstream connectivity, not just process liveness ([#744](https://github.com/bluish3101/headroom/issues/744)) ([5dfb446](https://github.com/bluish3101/headroom/commit/5dfb446da1fb65002e0dea18a90210a2a026f0b3))
* **init:** guard persistent task startup ([#616](https://github.com/bluish3101/headroom/issues/616)) ([9252d85](https://github.com/bluish3101/headroom/commit/9252d852c5a4c716eb5438b8f438d50e59a55fef))
* **init:** normalize Windows hook paths to forward slashes ([#788](https://github.com/bluish3101/headroom/issues/788)) ([6ea6e31](https://github.com/bluish3101/headroom/commit/6ea6e31f09845b2ad5c8bae73bcf353f3b629188))
* **init:** set ENABLE_TOOL_SEARCH=true so Claude Code keeps deferring tools ([#746](https://github.com/bluish3101/headroom/issues/746)) ([#995](https://github.com/bluish3101/headroom/issues/995)) ([500ec2b](https://github.com/bluish3101/headroom/commit/500ec2b7faebfd24c9ea404ae1dece40b3b14b84))
* **init:** suppress hook recovery output ([#760](https://github.com/bluish3101/headroom/issues/760)) ([b439599](https://github.com/bluish3101/headroom/commit/b4395993aecbb65b85a5b2479dfdb35ea243bf54))
* **install:** close parent log fd in start_detached_agent ([#1576](https://github.com/bluish3101/headroom/issues/1576)) ([816cb85](https://github.com/bluish3101/headroom/commit/816cb85fa8ee8d349fe673e7affd9a54acb1207d))
* **install:** guard install_agent_ensure against duplicate runtime spawns ([#1301](https://github.com/bluish3101/headroom/issues/1301)) ([8da0b4e](https://github.com/bluish3101/headroom/commit/8da0b4e565be2d5f798741bb9b7bee70c2102c8c))
* **install:** pass sc.exe create as raw command line so binPath= quoting survives ([#1654](https://github.com/bluish3101/headroom/issues/1654)) ([#1702](https://github.com/bluish3101/headroom/issues/1702)) ([d6e0710](https://github.com/bluish3101/headroom/commit/d6e07102283745a44aece2222f84c1599eabf90a))
* **install:** persist --no-http2 override through install apply ([#1676](https://github.com/bluish3101/headroom/issues/1676)) ([6fb5f3b](https://github.com/bluish3101/headroom/commit/6fb5f3bc3dfa60e56744f85cf049524d43104a31))
* **install:** repair macOS launchd restart/start lifecycle ([#1290](https://github.com/bluish3101/headroom/issues/1290)) ([da1a397](https://github.com/bluish3101/headroom/commit/da1a3973ed79d89617087ec315e77fb82356c03b))
* **install:** stop duplicating ENTRYPOINT in persistent-docker runtime command ([#833](https://github.com/bluish3101/headroom/issues/833)) ([#1348](https://github.com/bluish3101/headroom/issues/1348)) ([feedead](https://github.com/bluish3101/headroom/commit/feedead07772a27b872a448281a2d17e539d4702))
* **install:** use Windows-safe PID liveness probe in runtime_status ([#1544](https://github.com/bluish3101/headroom/issues/1544)) ([#1560](https://github.com/bluish3101/headroom/issues/1560)) ([6b227b9](https://github.com/bluish3101/headroom/commit/6b227b9c906d708923f39c0d877989a49942adae))
* **install:** write deployment manifest atomically and tolerate corrupt manifests ([#1303](https://github.com/bluish3101/headroom/issues/1303)) ([42bdf23](https://github.com/bluish3101/headroom/commit/42bdf23d241388cd1a2567f8481b51dacdd8ec83))
* **io:** use UTF-8 with locale fallback and preserve line endings on config/text I/O ([#1498](https://github.com/bluish3101/headroom/issues/1498)) ([1baa04e](https://github.com/bluish3101/headroom/commit/1baa04ef6576e08eeed685890354fca16ad4e6e3))
* **kompress:** hard override keeps must-keep tokens regardless of model score ([#1400](https://github.com/bluish3101/headroom/issues/1400)) ([42612c8](https://github.com/bluish3101/headroom/commit/42612c86dfc25a56a6ec6c1da74914e0741a51f6))
* **kompress:** never block the request path on the cold-cache model download ([#1161](https://github.com/bluish3101/headroom/issues/1161)) ([3fc2a78](https://github.com/bluish3101/headroom/commit/3fc2a78a5e20f159f7c5f198de6b91788dc64287))
* **langchain:** disable streaming on wrapped model during ainvoke() ([#1287](https://github.com/bluish3101/headroom/issues/1287)) ([3590046](https://github.com/bluish3101/headroom/commit/359004646bb2cda2b99cf3ef154539b7fa81aa72))
* **learn:** aggregate verbosity baselines across projects instead of overwriting ([#1288](https://github.com/bluish3101/headroom/issues/1288)) ([27a5468](https://github.com/bluish3101/headroom/commit/27a546834960b349e710a0b2e86ca3471523f34d))
* **learn:** claude-cli streams output with idle timeout ([#373](https://github.com/bluish3101/headroom/issues/373)) ([9bff575](https://github.com/bluish3101/headroom/commit/9bff5752bbd769902f249cdfde42bc53539afd02))
* **learn:** decode directory names with spaces in Windows project paths ([#997](https://github.com/bluish3101/headroom/issues/997)) ([#1027](https://github.com/bluish3101/headroom/issues/1027)) ([2d3701b](https://github.com/bluish3101/headroom/commit/2d3701b59e9ff8aedc2a282c4467f27ca2355d62))
* **learn:** handle Windows UTF-8, drive-letter paths, and CLI shim fallback ([#1895](https://github.com/bluish3101/headroom/issues/1895)) ([e3b45e4](https://github.com/bluish3101/headroom/commit/e3b45e402bc019c4de5f15c458c59696a68a8aff))
* **learn:** parse fenced JSON even with a prose preamble ([#1988](https://github.com/bluish3101/headroom/issues/1988)) ([d2170b1](https://github.com/bluish3101/headroom/commit/d2170b1922d63e586f672e0b86bcb8b7c9de0283))
* **learn:** scan subagent and workflow transcripts ([#1045](https://github.com/bluish3101/headroom/issues/1045)) ([0ddd4ed](https://github.com/bluish3101/headroom/commit/0ddd4ed9e92fe898373036ba3be228f9afc3bc5a))
* **litellm:** surface Bedrock cache token usage in non-streaming responses ([#1848](https://github.com/bluish3101/headroom/issues/1848)) ([d604e86](https://github.com/bluish3101/headroom/commit/d604e86904525d67d618e7920cd7ce0dac6e903d))
* make headroom wrap readiness probe timeout configurable for slow ML imports ([#581](https://github.com/bluish3101/headroom/issues/581)) ([163677b](https://github.com/bluish3101/headroom/commit/163677b405d7ca8a54d6d7c798bf6ead90da7880))
* **mcp:** correct default Claude Code config path in ClaudeRegistrar ([#1859](https://github.com/bluish3101/headroom/issues/1859)) ([c85731d](https://github.com/bluish3101/headroom/commit/c85731dc23832971993653c2fae7ae65e1db27ac))
* **mcp:** isolate ClaudeRegistrar CLI config env ([#1888](https://github.com/bluish3101/headroom/issues/1888)) ([1c947b1](https://github.com/bluish3101/headroom/commit/1c947b1103fa66563a01ea638f1669ee053018e6))
* **mcp:** register managed installs with a resolvable headroom command ([#1386](https://github.com/bluish3101/headroom/issues/1386)) ([22def93](https://github.com/bluish3101/headroom/commit/22def931770e6138d16f62daec39501951e68e64))
* **mcp:** report correct savings_percent in headroom_compress ([#1106](https://github.com/bluish3101/headroom/issues/1106)) ([f216e43](https://github.com/bluish3101/headroom/commit/f216e430559759f51b53eb44e76e030e6a83c80a))
* **mcp:** show lifetime totals and label rolling session scope in headroom_stats ([#1428](https://github.com/bluish3101/headroom/issues/1428)) ([1c0e152](https://github.com/bluish3101/headroom/commit/1c0e15243eda8f2dc868fe9ed4a08d944893686b))
* **mcp:** surface dead proxy state ([#1786](https://github.com/bluish3101/headroom/issues/1786)) ([931eed8](https://github.com/bluish3101/headroom/commit/931eed879d26512b2dbdf3ea4246e4f7b2c97a70))
* **memory/sync:** don't clobber memories sharing a first line ([#1976](https://github.com/bluish3101/headroom/issues/1976)) ([5e14b8c](https://github.com/bluish3101/headroom/commit/5e14b8c0f293df78f2576a9fc7eb90189e604cb5))
* **memory/sync:** make Codex AGENTS.md adapter additive (stop wiping memories) ([#1674](https://github.com/bluish3101/headroom/issues/1674)) ([7fd0c42](https://github.com/bluish3101/headroom/commit/7fd0c42ced9ecdf2a5411ff85d554b9e39ceb0b6))
* **memory:** cap local embedder CPU thread oversubscription ([#198](https://github.com/bluish3101/headroom/issues/198)) ([#1559](https://github.com/bluish3101/headroom/issues/1559)) ([b84afbf](https://github.com/bluish3101/headroom/commit/b84afbfb833999ddf164d324971bf6c11014a9d3))
* **memory:** resolve Trae cwd metadata from user reminders ([#1737](https://github.com/bluish3101/headroom/issues/1737)) ([#1887](https://github.com/bluish3101/headroom/issues/1887)) ([3e85eb1](https://github.com/bluish3101/headroom/commit/3e85eb1880af5663cf083492f1dc1415a354bd99))
* **memory:** singleflight LocalBackend init to stop cold-start races ([#1691](https://github.com/bluish3101/headroom/issues/1691)) ([bec47a1](https://github.com/bluish3101/headroom/commit/bec47a1898883919ad8c5ea41e3a7443a6890e7f))
* **memory:** use ONNX embedder for `wrap --memory` sync ([#1092](https://github.com/bluish3101/headroom/issues/1092)) ([#1262](https://github.com/bluish3101/headroom/issues/1262)) ([4f9feda](https://github.com/bluish3101/headroom/commit/4f9fedaa7a02e41114b5d5f4606f95f903e17b2a))
* **openclaw:** declare headroom_retrieve tool contract ([#947](https://github.com/bluish3101/headroom/issues/947)) ([7c8c909](https://github.com/bluish3101/headroom/commit/7c8c909c853a264c833c645403cbbb1894b91432))
* **openclaw:** detect uv-installed headroom binary in ~/.local/bin ([#1459](https://github.com/bluish3101/headroom/issues/1459)) ([adaeb88](https://github.com/bluish3101/headroom/commit/adaeb88a4d5512da5bd0bf58c1e3a276a5269d44))
* **openclaw:** wrap plugin export as {register} object for OpenClaw 2026.x compatibility ([#1218](https://github.com/bluish3101/headroom/issues/1218)) ([2e6c442](https://github.com/bluish3101/headroom/commit/2e6c442dc87f0853313b18ab1a7c80e991058bf7))
* **opencode:** preserve custom OpenAI gateway paths ([#1596](https://github.com/bluish3101/headroom/issues/1596)) ([c19347c](https://github.com/bluish3101/headroom/commit/c19347c31046bf25baf9b1a816c9bede5d3ee807))
* **opencode:** route native providers + load transport plugin, fix Serena context ([#1573](https://github.com/bluish3101/headroom/issues/1573)) ([ad0034f](https://github.com/bluish3101/headroom/commit/ad0034f98191501c1a60d26383bc3ed9f6d532be))
* **opencode:** use local MCP config ([#1383](https://github.com/bluish3101/headroom/issues/1383)) ([4bd3ddf](https://github.com/bluish3101/headroom/commit/4bd3ddfaa5c5655540494b96e4f5d47724460c7d))
* **opencode:** write local MCP config ([#1381](https://github.com/bluish3101/headroom/issues/1381)) ([6c83790](https://github.com/bluish3101/headroom/commit/6c837906802f9c211513a182de2365071e4f7765))
* **packaging:** move hnswlib to optional [vector] extra so [all] needs no C++ toolchain ([#1499](https://github.com/bluish3101/headroom/issues/1499)) ([80fa086](https://github.com/bluish3101/headroom/commit/80fa086660b277798ba9e6c6ed8645ec029362da))
* **parser:** detect waste signals in Anthropic tool_result content blocks ([#815](https://github.com/bluish3101/headroom/issues/815)) ([929698a](https://github.com/bluish3101/headroom/commit/929698af1030e5926f3766d7d6ac292d6e38437b))
* patch nltk vulnerability (CVE-2026-54293) ([#1929](https://github.com/bluish3101/headroom/issues/1929)) ([28ca61f](https://github.com/bluish3101/headroom/commit/28ca61fc9d3e36d5f967da6b3f75d6bccfeb0306))
* patch rtk hook script to use absolute path after register_claude_hooks ([#571](https://github.com/bluish3101/headroom/issues/571)) ([b618d2d](https://github.com/bluish3101/headroom/commit/b618d2d11a25ffaa00729b17fb41bd41037f4090))
* **perf:** surface RTK/CLI context-tool savings in perf and the session card ([#1433](https://github.com/bluish3101/headroom/issues/1433)) ([9362747](https://github.com/bluish3101/headroom/commit/93627471b72e3200e3ca78e1fb345c174414b716))
* **policy:** correct warm-cache penalty in net_mutation_gain to (S + dT) ([#903](https://github.com/bluish3101/headroom/issues/903)) ([0632eba](https://github.com/bluish3101/headroom/commit/0632eba6c3bdf5b030d794d3dfefa3c29543d2e8))
* preserve anthropic passthrough tool order ([#1427](https://github.com/bluish3101/headroom/issues/1427)) ([a932247](https://github.com/bluish3101/headroom/commit/a9322477e33ec2c5ccd6442d3f72c17b7388c9e0))
* preserve Claude Code tool-search deferral through the proxy ([#746](https://github.com/bluish3101/headroom/issues/746)) ([#753](https://github.com/bluish3101/headroom/issues/753)) ([1c8c538](https://github.com/bluish3101/headroom/commit/1c8c538780d5c9a43781f1fdd9eeda2657280446))
* **providers:** update DeepSeek V3 context limit from 128K to 1M ([#1038](https://github.com/bluish3101/headroom/issues/1038)) ([#1137](https://github.com/bluish3101/headroom/issues/1137)) ([bcabc5c](https://github.com/bluish3101/headroom/commit/bcabc5cb11c7c411ed29dac1fcc3771833ac8524))
* **proxy/auth:** match real Anthropic OAuth token prefix (sk-ant-oat) ([#1672](https://github.com/bluish3101/headroom/issues/1672)) ([8cddf9b](https://github.com/bluish3101/headroom/commit/8cddf9b58ea9ed11a0cd3532be6e779dffe57b55))
* **proxy/openai:** thread savings-profile kwargs into chat completions ([#1606](https://github.com/bluish3101/headroom/issues/1606)) ([7ff842d](https://github.com/bluish3101/headroom/commit/7ff842da170b5bceb5d67048473eeb8a18e09a51))
* **proxy/openai:** translate max_tokens -&gt; max_completion_tokens on chat path ([#1774](https://github.com/bluish3101/headroom/issues/1774)) ([285808b](https://github.com/bluish3101/headroom/commit/285808b90ea5532fe319c94d408699cb46b2e5f8))
* **proxy:** add --protect-tool-results to prevent lossy compression of exact-output Bash results ([#1374](https://github.com/bluish3101/headroom/issues/1374)) ([51d4bcf](https://github.com/bluish3101/headroom/commit/51d4bcfc113d95a9c843937fbdd3751483bc1dab))
* **proxy:** add an Anthropic buffered read-timeout override ([#1331](https://github.com/bluish3101/headroom/issues/1331)) ([3be2526](https://github.com/bluish3101/headroom/commit/3be2526b76caa8ff1050e44807386874571e079b))
* **proxy:** add native Bedrock converse-stream route ([#917](https://github.com/bluish3101/headroom/issues/917)) ([b08ec15](https://github.com/bluish3101/headroom/commit/b08ec15b0d392b8b8cf93dbadaee4b7e6b465f1c))
* **proxy:** add versionless Vertex AI routes for Claude Code compatibility ([#1321](https://github.com/bluish3101/headroom/issues/1321)) ([bb3e040](https://github.com/bluish3101/headroom/commit/bb3e040a463b66801323c261e9547f1e4a2ccfbd))
* **proxy:** allow disabling periodic TOIN stats logging ([#1265](https://github.com/bluish3101/headroom/issues/1265)) ([b5f63d8](https://github.com/bluish3101/headroom/commit/b5f63d8fa9f81f39eab854f29a2fdc39878566df))
* **proxy:** bind before eager preload so a hung compressor load can't block startup ([#1500](https://github.com/bluish3101/headroom/issues/1500)) ([d5ac07f](https://github.com/bluish3101/headroom/commit/d5ac07fc451516c3b1fe7ece2f01f8d85c126925))
* **proxy:** bound Codex WS compression fallback latency ([#1802](https://github.com/bluish3101/headroom/issues/1802)) ([d24a3f8](https://github.com/bluish3101/headroom/commit/d24a3f842551d36c14dc0ec146a9302e256c5c0f))
* **proxy:** bound HF tokenizer load and offload token counting off event loop ([#1738](https://github.com/bluish3101/headroom/issues/1738)) ([46d5d68](https://github.com/bluish3101/headroom/commit/46d5d685d9bcdced1f77ffdc0f2d3a8ee8a1f319))
* **proxy:** build SSL contexts for custom CA bundles ([#1134](https://github.com/bluish3101/headroom/issues/1134)) ([561ba17](https://github.com/bluish3101/headroom/commit/561ba17ec2e05b463682fd3ecfe7ca43b558684f))
* **proxy:** cancel retry backoff on shutdown ([#1834](https://github.com/bluish3101/headroom/issues/1834)) ([da2d8dc](https://github.com/bluish3101/headroom/commit/da2d8dc9dbf3edfcd1c3f6429db32374a6bebc64))
* **proxy:** compress Anthropic user text blocks when enabled ([#1875](https://github.com/bluish3101/headroom/issues/1875)) ([e36439a](https://github.com/bluish3101/headroom/commit/e36439a9411bf7fc93b4a5dceac50aa4570a6105))
* **proxy:** count exhausted upstream 5xx as failed across all providers ([#1571](https://github.com/bluish3101/headroom/issues/1571)) ([e365ad7](https://github.com/bluish3101/headroom/commit/e365ad71524813d348fdc45f09535da8cbe7b53a))
* **proxy:** expose persistent savings metrics ([#1647](https://github.com/bluish3101/headroom/issues/1647)) ([5fe4e7b](https://github.com/bluish3101/headroom/commit/5fe4e7b19530da0c2d07d17f20b18d79b6fab367))
* **proxy:** F4 — trust X-Forwarded-* only behind allow-listed gateway ([d10bd5f](https://github.com/bluish3101/headroom/commit/d10bd5f59c5a36e14f6c5f0480b821532521b753))
* **proxy:** fail open when kompress saturation would exhaust pre-upstream budget ([#1430](https://github.com/bluish3101/headroom/issues/1430)) ([15ac650](https://github.com/bluish3101/headroom/commit/15ac650d409ea7def9e54d9962af1cfdc1f11f5d))
* **proxy:** forward request-id headers on the streaming path ([#1100](https://github.com/bluish3101/headroom/issues/1100)) ([#1258](https://github.com/bluish3101/headroom/issues/1258)) ([3d59df7](https://github.com/bluish3101/headroom/commit/3d59df7be889d6d7218c5552e40a4f736d80a3af))
* **proxy:** freeze must forward cached (compressed) prefix byte-identical — stop token-mode cache busting ([#1850](https://github.com/bluish3101/headroom/issues/1850)) ([248ae0f](https://github.com/bluish3101/headroom/commit/248ae0f3e0d4d7ff2e23837e628880dcbda4411a))
* **proxy:** fsync savings dir after atomic rename ([#1764](https://github.com/bluish3101/headroom/issues/1764)) ([7de2c1e](https://github.com/bluish3101/headroom/commit/7de2c1e4c2ca8aefd73d3c419dfbcdd881a63bd2))
* **proxy:** gate CCR retrieve/compress endpoints to loopback ([#1338](https://github.com/bluish3101/headroom/issues/1338)) ([acafb2d](https://github.com/bluish3101/headroom/commit/acafb2d0f668dc5f5848fa2940545743899a30c2))
* **proxy:** handle streaming CCR retrieval ([#1451](https://github.com/bluish3101/headroom/issues/1451)) ([d337e3b](https://github.com/bluish3101/headroom/commit/d337e3b828ffc1f22cd5ca1884500b8905e9bd82))
* **proxy:** hoist ccr_workspace_key default so /v1/messages survives CCR-inject off ([#1096](https://github.com/bluish3101/headroom/issues/1096)) ([1deb947](https://github.com/bluish3101/headroom/commit/1deb947ac139f8525c0da2bbe86d6caacfc48a49))
* **proxy:** honor force_kompress routing profile ([#996](https://github.com/bluish3101/headroom/issues/996)) ([b4682d6](https://github.com/bluish3101/headroom/commit/b4682d6f91c782286553875b7fd8cee6101f1b0f))
* **proxy:** honor HEADROOM_EXCLUDE_TOOLS for Codex /v1/responses tool outputs ([#940](https://github.com/bluish3101/headroom/issues/940)) ([#1053](https://github.com/bluish3101/headroom/issues/1053)) ([f03e77b](https://github.com/bluish3101/headroom/commit/f03e77bec05494aebb4de188eddf2b57f99f6997))
* **proxy:** honor x-headroom-base-url on /v1/messages route ([#1763](https://github.com/bluish3101/headroom/issues/1763)) ([bb2acf7](https://github.com/bluish3101/headroom/commit/bb2acf700a62ee3a76ba181052e36904af4f11be))
* **proxy:** include system/tools/sampling in cache key ([#1473](https://github.com/bluish3101/headroom/issues/1473)) ([312129a](https://github.com/bluish3101/headroom/commit/312129a8e7465c97402ae45b9e9d51b7f4b5b0c7))
* **proxy:** keep cache_control bounded + stable so the freeze overlay stops busting ([#1852](https://github.com/bluish3101/headroom/issues/1852)) ([4820134](https://github.com/bluish3101/headroom/commit/48201345be16a8b5aad74e8c390850dce0f34ec4))
* **proxy:** keep codex image-generation WS turns alive through the relay ([#1000](https://github.com/bluish3101/headroom/issues/1000)) ([7dbbb40](https://github.com/bluish3101/headroom/commit/7dbbb4077e7bb11b3da4634573cfc1d998e139ec))
* **proxy:** keep large compression results on the critical path ([#296](https://github.com/bluish3101/headroom/issues/296)) ([#1352](https://github.com/bluish3101/headroom/issues/1352)) ([90734b6](https://github.com/bluish3101/headroom/commit/90734b691a50669eaaae7c8739243e7bfc313326))
* **proxy:** keep OpenAI tool observations mutable in cache mode ([#1884](https://github.com/bluish3101/headroom/issues/1884)) ([55efb1c](https://github.com/bluish3101/headroom/commit/55efb1c77d5b67f7ad0620372c6256c8b0547591))
* **proxy:** lazy-import server to avoid fastapi crash ([#442](https://github.com/bluish3101/headroom/issues/442)) ([93c6937](https://github.com/bluish3101/headroom/commit/93c69372e614f2b04873bed75602a88d2256a7fc))
* **proxy:** make budget enforcement actually work ([#885](https://github.com/bluish3101/headroom/issues/885)) ([a14ab45](https://github.com/bluish3101/headroom/commit/a14ab45cf0e6e698c52a0efd0448ca7c8ba0b31f))
* **proxy:** make CCR multi-worker warning conditional on backend ([#770](https://github.com/bluish3101/headroom/issues/770)) ([d76a729](https://github.com/bluish3101/headroom/commit/d76a7296df121365d74c415b8c702a3ad80abd30))
* **proxy:** make Kompress eager preload cache-only so a cold cache can't block startup ([#783](https://github.com/bluish3101/headroom/issues/783)) ([841663d](https://github.com/bluish3101/headroom/commit/841663da16971b1e0d8e204fdf18e4bafedaf9e0))
* **proxy:** offload /v1/compress to the compression executor to stop blocking the loop ([#1501](https://github.com/bluish3101/headroom/issues/1501)) ([27e010e](https://github.com/bluish3101/headroom/commit/27e010e38f37e64767e94d144fd4353fcdbe1e47))
* **proxy:** persist lifetime cache-read savings across restarts ([#1665](https://github.com/bluish3101/headroom/issues/1665)) ([908997e](https://github.com/bluish3101/headroom/commit/908997ef61d91a7e912637c785176719a5f1c719))
* **proxy:** preserve byte-faithful Anthropic tool forwarding ([#1222](https://github.com/bluish3101/headroom/issues/1222)) ([1f18d59](https://github.com/bluish3101/headroom/commit/1f18d5980972fc7b2091ca0be5318d06c4edfa79))
* **proxy:** preserve Responses memory continuations with store=false ([#1103](https://github.com/bluish3101/headroom/issues/1103)) ([cdfeeac](https://github.com/bluish3101/headroom/commit/cdfeeacc63e6cb98d34e245f2330f0e1af531d32))
* **proxy:** preserve Responses passthrough bytes ([#1598](https://github.com/bluish3101/headroom/issues/1598)) ([2a34a82](https://github.com/bluish3101/headroom/commit/2a34a822f2a39da57fbd07575752888f5515f51a))
* **proxy:** preserve streaming passthrough beta headers ([#1783](https://github.com/bluish3101/headroom/issues/1783)) ([0f553a8](https://github.com/bluish3101/headroom/commit/0f553a8ebbd6d790ca622f95f389b5e7d11a41ce))
* **proxy:** preserve upstream 5xx status on retry exhaustion ([#1570](https://github.com/bluish3101/headroom/issues/1570)) ([7836aea](https://github.com/bluish3101/headroom/commit/7836aea2be8577b0f593c9cfcff1da5f5e0ee3c8))
* **proxy:** queue mid-turn user messages on non-Bedrock streaming path ([#1377](https://github.com/bluish3101/headroom/issues/1377)) ([b09f027](https://github.com/bluish3101/headroom/commit/b09f0270625a4dbee6fc2805f52f19492e68f1f6))
* **proxy:** read RTK gain stats globally by default ([#957](https://github.com/bluish3101/headroom/issues/957)) ([b70fccb](https://github.com/bluish3101/headroom/commit/b70fccbe174e1adff0f52ceaf9bec0dcda0c73da))
* **proxy:** record cache metrics for non-streaming backend paths ([#1271](https://github.com/bluish3101/headroom/issues/1271)) ([8580404](https://github.com/bluish3101/headroom/commit/85804043ff1f418148dd00c42a2dcdffe61a57a6))
* **proxy:** register interceptor in explicit transforms list when HEADROOM_INTERCEPT_ENABLED ([#1376](https://github.com/bluish3101/headroom/issues/1376)) ([55c700c](https://github.com/bluish3101/headroom/commit/55c700c686309c63eb8d9d7d21f30d1838e1c9e7))
* **proxy:** release _active_streams session lock on setup-phase errors ([#1864](https://github.com/bluish3101/headroom/issues/1864)) ([2ccd831](https://github.com/bluish3101/headroom/commit/2ccd831032e23248879bd38c5bde947d3a0a54f3))
* **proxy:** report real input tokens on streaming message_start ([#1132](https://github.com/bluish3101/headroom/issues/1132)) ([#1305](https://github.com/bluish3101/headroom/issues/1305)) ([70cc96a](https://github.com/bluish3101/headroom/commit/70cc96a386baff345669722dc15fde694811d2d6))
* **proxy:** restore Codex usage headers on WS and streaming SSE transports ([#577](https://github.com/bluish3101/headroom/issues/577)) ([#794](https://github.com/bluish3101/headroom/issues/794)) ([0ce68de](https://github.com/bluish3101/headroom/commit/0ce68dedd770d5411d16abe30e5ea9dd0b7d8eee))
* **proxy:** retry HTTP/2 stream resets instead of 502ing ([#1645](https://github.com/bluish3101/headroom/issues/1645)) ([2ce19c2](https://github.com/bluish3101/headroom/commit/2ce19c2c55710cdc5f7a4bb88803f05e4b31feff))
* **proxy:** retry passthrough on transient upstream connection close ([#1513](https://github.com/bluish3101/headroom/issues/1513)) ([5d14080](https://github.com/bluish3101/headroom/commit/5d14080c948b04ccd997d2434b37604440701888))
* **proxy:** retry upstream 429 with Retry-After on both forwarders ([#1329](https://github.com/bluish3101/headroom/issues/1329)) ([90bee89](https://github.com/bluish3101/headroom/commit/90bee89243004846cfc86ad3bf888579acb27522))
* **proxy:** retry upstream 529 overloaded like 429 on both forwarders ([#1495](https://github.com/bluish3101/headroom/issues/1495)) ([547b15d](https://github.com/bluish3101/headroom/commit/547b15dab2c18b8d70504c366dc33e22111255e5))
* **proxy:** route Codex OAuth image requests ([#1215](https://github.com/bluish3101/headroom/issues/1215)) ([381d771](https://github.com/bluish3101/headroom/commit/381d771e4618585e5756e20c090354ccad09183f))
* **proxy:** route Foundry Anthropic messages ([#1878](https://github.com/bluish3101/headroom/issues/1878)) ([739f654](https://github.com/bluish3101/headroom/commit/739f654bbd71b3e31ade40ae9eadf812b362beec))
* **proxy:** scope CORS to loopback + gate operator/content endpoints ([#1226](https://github.com/bluish3101/headroom/issues/1226)) ([bd55a42](https://github.com/bluish3101/headroom/commit/bd55a426bc3ec6cd3e0ad46cd3182209afb84937))
* **proxy:** serve /favicon.ico locally instead of tunneling upstream ([#1787](https://github.com/bluish3101/headroom/issues/1787)) ([#1847](https://github.com/bluish3101/headroom/issues/1847)) ([3076e32](https://github.com/bluish3101/headroom/commit/3076e3217228cbb208849d5005a2cd5e1d69606e))
* **proxy:** stamp X-Client: codex on Responses endpoint for unidentified callers ([#1036](https://github.com/bluish3101/headroom/issues/1036)) ([b0cd032](https://github.com/bluish3101/headroom/commit/b0cd0329c75c8556c51c1c96dc19f2ab6a23677d))
* **proxy:** stop re-compressing headroom_retrieve output and emitting unredeemable markers ([#1323](https://github.com/bluish3101/headroom/issues/1323)) ([43494ff](https://github.com/bluish3101/headroom/commit/43494ff526468a63ecf028e081a357d1f619ef56))
* **proxy:** stop rtk stat failures from corrupting session baseline ([#1693](https://github.com/bluish3101/headroom/issues/1693)) ([681b9a8](https://github.com/bluish3101/headroom/commit/681b9a8c1a96af564767d221e92e0ef6620f8a37))
* **proxy:** strip 1m model suffix before upstream forwarding ([#1840](https://github.com/bluish3101/headroom/issues/1840)) ([e22d745](https://github.com/bluish3101/headroom/commit/e22d7453d4c6fcf084135ad65c21dd4feb9927ad))
* **proxy:** strip Codex lite header from OpenAI WebSockets ([#1543](https://github.com/bluish3101/headroom/issues/1543)) ([5d3803a](https://github.com/bluish3101/headroom/commit/5d3803a21c53907e2fea900524e48b510dd59d7a))
* **proxy:** strip Codex lite header on the HTTP /responses path ([#1663](https://github.com/bluish3101/headroom/issues/1663)) ([9fbd47b](https://github.com/bluish3101/headroom/commit/9fbd47ba6bdf38b618795541ee517b7e2fa2c6df))
* **proxy:** strip duplicated upstream server headers ([#1828](https://github.com/bluish3101/headroom/issues/1828)) ([d2a86b5](https://github.com/bluish3101/headroom/commit/d2a86b590978cae32bf95a20013ad539e942be31))
* **proxy:** strip inbound Content-Encoding on messages/chat forward ([#1970](https://github.com/bluish3101/headroom/issues/1970)) ([4cb33cd](https://github.com/bluish3101/headroom/commit/4cb33cd9e3766a1255cd9fbb7ac577c1d62b1aa2))
* **proxy:** subtract cache write premiums from net savings ([#1800](https://github.com/bluish3101/headroom/issues/1800)) ([53a465b](https://github.com/bluish3101/headroom/commit/53a465b121e0a7f45f862a21829639423226a5eb))
* **proxy:** treat NODE_EXTRA_CA_CERTS as additive, not replacement ([#998](https://github.com/bluish3101/headroom/issues/998)) ([#1031](https://github.com/bluish3101/headroom/issues/1031)) ([c987283](https://github.com/bluish3101/headroom/commit/c98728363a1079f39bb19da2955cc859b35900a8))
* **proxy:** wire --compression-max-workers / HEADROOM_COMPRESSION_MAX_WORKERS ([#1632](https://github.com/bluish3101/headroom/issues/1632)) ([814ffa3](https://github.com/bluish3101/headroom/commit/814ffa36a4d1bb40165a630f96a855452037735e))
* **read-lifecycle:** persist STALE Read originals in the CCR store ([#1488](https://github.com/bluish3101/headroom/issues/1488)) ([9157173](https://github.com/bluish3101/headroom/commit/915717301860036005f3a51a5306762ae588ed11))
* recover persistent proxy feature checks and reject non-Copilot exchange URL ([#1465](https://github.com/bluish3101/headroom/issues/1465)) ([16c638b](https://github.com/bluish3101/headroom/commit/16c638bc211ecc6d1768bbe36e0c12971996e104))
* **release:** sync all package versions to v0.31.0 ([#1882](https://github.com/bluish3101/headroom/issues/1882)) ([662b7bc](https://github.com/bluish3101/headroom/commit/662b7bc00eb4cfb1f72449e510fe576d240db384))
* **relevance:** gate ONNX embedding backend behind AVX2 to avoid SIGILL ([#1723](https://github.com/bluish3101/headroom/issues/1723)) ([#1765](https://github.com/bluish3101/headroom/issues/1765)) ([728b330](https://github.com/bluish3101/headroom/commit/728b33088b25c390d9b06082afab058e1dc7f028))
* remove agents.md ([#1540](https://github.com/bluish3101/headroom/issues/1540)) ([a7d3360](https://github.com/bluish3101/headroom/commit/a7d3360a05d4fd139cceab5f72d7de4ef7c712b0))
* respect COPILOT_PROVIDER_TYPE env var when provider_type is auto ([#549](https://github.com/bluish3101/headroom/issues/549)) ([24cf256](https://github.com/bluish3101/headroom/commit/24cf256e50fbd0df8ac67fefa90982cd20807274))
* restore token-mode compression on frozen prefixes ([#1489](https://github.com/bluish3101/headroom/issues/1489)) ([8e0dadf](https://github.com/bluish3101/headroom/commit/8e0dadfe02da144ca0b27906a8a82bb4be2cb720))
* route v1internal code assist requests to cloudcode-pa.googleapis… ([#821](https://github.com/bluish3101/headroom/issues/821)) ([e20f16b](https://github.com/bluish3101/headroom/commit/e20f16b1a65710f532aa019ef60ac7a18a4e7f46))
* **router:** degrade to pure-Python detection on native panic ([#1123](https://github.com/bluish3101/headroom/issues/1123)) ([#1260](https://github.com/bluish3101/headroom/issues/1260)) ([a00fb67](https://github.com/bluish3101/headroom/commit/a00fb6761eddf59ede6767211da06f8840552f14))
* **router:** honor MCP aliases in excluded tools ([#1822](https://github.com/bluish3101/headroom/issues/1822)) ([#1863](https://github.com/bluish3101/headroom/issues/1863)) ([140d6e4](https://github.com/bluish3101/headroom/commit/140d6e4f9609eefd674dc435cfcaa9d4e451f9b0))
* **rtk:** link managed rtk onto PATH instead of mutating the hook ([#1698](https://github.com/bluish3101/headroom/issues/1698)) ([140cb05](https://github.com/bluish3101/headroom/commit/140cb05fbc76e0cd1a54d2a8f98cbbd634a227cd))
* **rtk:** stop hook registration timing out on a forked daemon ([#1314](https://github.com/bluish3101/headroom/issues/1314)) ([9758817](https://github.com/bluish3101/headroom/commit/97588179790da9fa13ad6793b3cb8e485b43f9b3))
* **savings:** count cache-read tokens in input cost estimate ([#1429](https://github.com/bluish3101/headroom/issues/1429)) ([72ade37](https://github.com/bluish3101/headroom/commit/72ade3711211183b9134a46d9c5d45db6a87edc2))
* schema compaction must not drop property names that match DROP_KEYS ([#785](https://github.com/bluish3101/headroom/issues/785)) ([ae2122f](https://github.com/bluish3101/headroom/commit/ae2122fda8ff0efc03d609d27270453fea3a8718))
* **scripts:** rename .releaseetadata to .releasemetadata ([#1246](https://github.com/bluish3101/headroom/issues/1246)) ([772adc9](https://github.com/bluish3101/headroom/commit/772adc93b253d73e91a1a4888e5338f1f71a887a))
* **search-compressor:** CJK-aware relevance + harden Rust/Python parity ([#1749](https://github.com/bluish3101/headroom/issues/1749)) ([985621d](https://github.com/bluish3101/headroom/commit/985621d60e3c80d94d1205b863bb4974cd346b62))
* **security:** block DNS-rebinding on /debug/* and /stats/reset via Host-header allowlist ([#605](https://github.com/bluish3101/headroom/issues/605)) ([b4b5025](https://github.com/bluish3101/headroom/commit/b4b50253f16d0a30f1d17a959753137e997efbac))
* **serena:** stop the Serena dashboard popup and make --no-serena actually disable Serena ([#1003](https://github.com/bluish3101/headroom/issues/1003)) ([919379a](https://github.com/bluish3101/headroom/commit/919379a8a1731a0002d813a79d880ad35f8bbbc9))
* skip Magika backend on x86 CPUs without AVX2 ([#1162](https://github.com/bluish3101/headroom/issues/1162)) ([64783d8](https://github.com/bluish3101/headroom/commit/64783d8824e3c3afc43d9980573d9440693d0963))
* **smart-crusher:** honor enable_ccr_marker on the opaque-blob path ([#1130](https://github.com/bluish3101/headroom/issues/1130)) ([27d6f8e](https://github.com/bluish3101/headroom/commit/27d6f8e2a767b58eb7d2f47599f68e8bdc49fb7f))
* **ssl:** upstream httpx client inherits SSL_CERT_FILE, REQUESTS_CA_BUNDLE, NODE_EXTRA_CA_CERTS ([#745](https://github.com/bluish3101/headroom/issues/745)) ([e50fbb3](https://github.com/bluish3101/headroom/commit/e50fbb3e0d61d561456d7b0ff9e0a8ee106a2f02))
* **streaming:** preserve server_tool_use sse blocks ([#1826](https://github.com/bluish3101/headroom/issues/1826)) ([4ac5493](https://github.com/bluish3101/headroom/commit/4ac54934cbebe77f72a2cd7432ea792f17a5fd65))
* **subscription:** only reset 5h contribution on real rollover, not API jitter ([#1255](https://github.com/bluish3101/headroom/issues/1255)) ([8d6c175](https://github.com/bluish3101/headroom/commit/8d6c175d605b88d1c5a7f5e7671778a0e54fb09e))
* **subscription:** run transcript token scan off the event loop ([#1263](https://github.com/bluish3101/headroom/issues/1263)) ([f03021f](https://github.com/bluish3101/headroom/commit/f03021f1b69ec1a099436a5f80e68d5266cad8bf))
* support Copilot Business subscription auth ([#641](https://github.com/bluish3101/headroom/issues/641)) ([0b4a4bd](https://github.com/bluish3101/headroom/commit/0b4a4bd4830ecec1bca64c2f62455c4c923d91df))
* suppress LiteLLM provider banner before import ([#874](https://github.com/bluish3101/headroom/issues/874)) ([f9384ef](https://github.com/bluish3101/headroom/commit/f9384ef4b780eaa1d8ca6dcc314ad430b87f524a))
* surface output reduction without a restart, and explain $0.00 savings on Python 3.14 ([#1296](https://github.com/bluish3101/headroom/issues/1296)) ([c30ec4c](https://github.com/bluish3101/headroom/commit/c30ec4cda8d5340dd98ba1653a7e85f684eb7c3d))
* **telemetry:** switch anonymous telemetry to opt-in (off by default) ([#1223](https://github.com/bluish3101/headroom/issues/1223)) ([b998697](https://github.com/bluish3101/headroom/commit/b99869778bb3ebe223015bdd051e3b9746c8a22c))
* **tests:** reset whole headroom logger subtree so caplog stays deterministic ([#1117](https://github.com/bluish3101/headroom/issues/1117)) ([fda4670](https://github.com/bluish3101/headroom/commit/fda4670ef8a8ee279f5afc38ccfecf966762ada2))
* **tls:** add HEADROOM_TLS_STRICT=0 toggle for corporate SSL inspection ([#1308](https://github.com/bluish3101/headroom/issues/1308)) ([#1341](https://github.com/bluish3101/headroom/issues/1341)) ([52068dd](https://github.com/bluish3101/headroom/commit/52068dd650d06d400db472efe6c7b47f539612aa))
* **toin:** publish skip compression recommendations ([#1782](https://github.com/bluish3101/headroom/issues/1782)) ([be51008](https://github.com/bluish3101/headroom/commit/be51008c701f18e6856efc65d46401dbd2c9856f))
* **tokenizers:** bound tiktoken vocab load so a stalled download cannot hang requests ([#956](https://github.com/bluish3101/headroom/issues/956)) ([#994](https://github.com/bluish3101/headroom/issues/994)) ([7e86baf](https://github.com/bluish3101/headroom/commit/7e86bafb9004e40716a04e22398d24157928ca67))
* **tokenizers:** price CJK/Kana/Hangul at ~1 token per char in EstimatingTokenCounter ([#1093](https://github.com/bluish3101/headroom/issues/1093)) ([a35fe86](https://github.com/bluish3101/headroom/commit/a35fe86e87725e660779f9cbbb0825f87f59d532))
* **transforms/content-router:** route grep/log output away from HTML extractor ([#1719](https://github.com/bluish3101/headroom/issues/1719)) ([0d18ef2](https://github.com/bluish3101/headroom/commit/0d18ef26f4d126f8eec9df1d34330a7129c4c63f))
* **transforms:** bound native content detection with a Windows watchdog ([#575](https://github.com/bluish3101/headroom/issues/575)) ([#1563](https://github.com/bluish3101/headroom/issues/1563)) ([95abca3](https://github.com/bluish3101/headroom/commit/95abca3abd69add5f075d241284b565e0014d5a4))
* **transforms:** gate tool string output from lossy compression ([#1307](https://github.com/bluish3101/headroom/issues/1307)) ([#1387](https://github.com/bluish3101/headroom/issues/1387)) ([c6c921a](https://github.com/bluish3101/headroom/commit/c6c921a7c135a19c68fcd85ac5bdddd4ee9c1e8d))
* **transforms:** normalize diff compressor context ([#1801](https://github.com/bluish3101/headroom/issues/1801)) ([838c523](https://github.com/bluish3101/headroom/commit/838c5234a877d4cf96f9e914cfd39d6d6addb211))
* **transforms:** pass through ragged tables instead of misaligning columns ([#1713](https://github.com/bluish3101/headroom/issues/1713)) ([c7665ca](https://github.com/bluish3101/headroom/commit/c7665ca08863da12dc9c656bd8bdf1f55c95bda7))
* **transforms:** use thread-local tree-sitter parsers to prevent pyo3 Unsendable panic ([#604](https://github.com/bluish3101/headroom/issues/604)) ([2ad300a](https://github.com/bluish3101/headroom/commit/2ad300aff801838efe5649b00a0396523a401a2a))
* **unwrap:** remove ANTHROPIC_BASE_URL + ENABLE_TOOL_SEARCH and init hooks on unwrap ([#992](https://github.com/bluish3101/headroom/issues/992)) ([5b84691](https://github.com/bluish3101/headroom/commit/5b846917701e346739346c99c48d5ab6e226e17d))
* use rtk native Cursor hook instead of injecting .cursorrules ([#756](https://github.com/bluish3101/headroom/issues/756)) ([#1846](https://github.com/bluish3101/headroom/issues/1846)) ([1573f1f](https://github.com/bluish3101/headroom/commit/1573f1fd0763408246f5dd0d7a92f32464f5fdbb))
* Vertex AI support for Claude Code with ANTHROPIC_VERTEX_BASE_URL ([#1393](https://github.com/bluish3101/headroom/issues/1393)) ([cff7247](https://github.com/bluish3101/headroom/commit/cff7247efd6fbecc1c2e66280a4a9b6381d7b7a4))
* **websocket:** harden responses websocket origin handling ([#1481](https://github.com/bluish3101/headroom/issues/1481)) ([c632023](https://github.com/bluish3101/headroom/commit/c632023cc1ec61d15f8f8e86efe3b54d51604a64))
* **windows:** pin UTF-8 encoding on text-mode subprocess calls ([#1311](https://github.com/bluish3101/headroom/issues/1311)) ([d633e81](https://github.com/bluish3101/headroom/commit/d633e8172ccfde4b08c302ecc4c4ef4ce27785f1))
* wire HEADROOM_EXCLUDE_TOOLS / HEADROOM_TOOL_PROFILES into Click proxy entrypoint ([#943](https://github.com/bluish3101/headroom/issues/943)) ([9b7b436](https://github.com/bluish3101/headroom/commit/9b7b436b04118d6ec4dcaebafc1c82e03e786f27))
* **wrap:** add Copilot unwrap command ([#1251](https://github.com/bluish3101/headroom/issues/1251)) ([b4fde0c](https://github.com/bluish3101/headroom/commit/b4fde0c3a4c2585d4aeda2c6987fe509a5296fe5))
* **wrap:** avoid duplicate top-level keys when injecting codex provider ([#884](https://github.com/bluish3101/headroom/issues/884)) ([dd22cfd](https://github.com/bluish3101/headroom/commit/dd22cfd72ad9265c25a95ef5536dc3d17e85dbbf))
* **wrap:** detach the shared proxy on Windows so it survives an ungraceful agent close ([#1464](https://github.com/bluish3101/headroom/issues/1464)) ([6cba441](https://github.com/bluish3101/headroom/commit/6cba4419d04bea79c1b44632a9288cde5b48bbce))
* **wrap:** isolate proxy stdio from proxy.log on Windows ([#1191](https://github.com/bluish3101/headroom/issues/1191)) ([959ab0d](https://github.com/bluish3101/headroom/commit/959ab0de471293e76df1f124ed0090c62e62c308))
* **wrap:** keep agent savings opt-in ([#1294](https://github.com/bluish3101/headroom/issues/1294)) ([b829ceb](https://github.com/bluish3101/headroom/commit/b829ceba84ce058dadb4e70f6766af13806a4385))
* **wrap:** keep Codex RTK guidance global ([#1240](https://github.com/bluish3101/headroom/issues/1240)) ([7c26a54](https://github.com/bluish3101/headroom/commit/7c26a54d53aa06a3d75e1111b285c2593155c43e))
* **wrap:** percent-encode non-ASCII cwd names in X-Headroom-Project header ([#1071](https://github.com/bluish3101/headroom/issues/1071)) ([9f712cc](https://github.com/bluish3101/headroom/commit/9f712ccbd7ec27b74f6ac7f20b7d2a9743dba1d8))
* **wrap:** preserve custom Codex provider base_url during proxy injection ([#1894](https://github.com/bluish3101/headroom/issues/1894)) ([372d6c8](https://github.com/bluish3101/headroom/commit/372d6c8cd4bec2d7f7448bf23503b11570f72b47))
* **wrap:** preserve custom Vertex base URL ([#1477](https://github.com/bluish3101/headroom/issues/1477)) ([75427bb](https://github.com/bluish3101/headroom/commit/75427bbd4ad14fcb1b205f3253ec4e24ae1d2118))
* **wrap:** remove rtk instructions from Codex AGENTS.md on unwrap ([#1604](https://github.com/bluish3101/headroom/issues/1604)) ([c9d717c](https://github.com/bluish3101/headroom/commit/c9d717c13c7ae006178e49b6570f63b3f82de9a2))
* **wrap:** replace stale-proxy detection with Vite-style port fallback ([#1406](https://github.com/bluish3101/headroom/issues/1406)) ([b4205c6](https://github.com/bluish3101/headroom/commit/b4205c68e63e1e12e354508d8c3ac7d54781268b))
* **wrap:** show the dashboard URL when the proxy is already running ([#1313](https://github.com/bluish3101/headroom/issues/1313)) ([b0146c4](https://github.com/bluish3101/headroom/commit/b0146c4ccd1e75dc7db21ef7f00dd4b3aa80e276))
* **wrap:** track shared proxy clients with markers ([#877](https://github.com/bluish3101/headroom/issues/877)) ([05bd56b](https://github.com/bluish3101/headroom/commit/05bd56bcb6b103fab5522da2b14295cf7bd8dbc1))
* **wrap:** write env.ANTHROPIC_BASE_URL to settings.json so daemon-spawned conversations inherit proxy ([#951](https://github.com/bluish3101/headroom/issues/951)) ([#1078](https://github.com/bluish3101/headroom/issues/1078)) ([a554c3a](https://github.com/bluish3101/headroom/commit/a554c3a0e6c5c57a7c745d8648024362d9d502a4))


### Performance Improvements

* **compression:** take large cold-start contexts off the synchronous kompress path ([#1171](https://github.com/bluish3101/headroom/issues/1171)) ([#1298](https://github.com/bluish3101/headroom/issues/1298)) ([6c68ff4](https://github.com/bluish3101/headroom/commit/6c68ff4e9f911af9dbd6108367acb3cab80d6f5e))
* **proxy:** cap compression workers to CPU count ([#1803](https://github.com/bluish3101/headroom/issues/1803)) ([0a3851b](https://github.com/bluish3101/headroom/commit/0a3851b24004727e734b61af4e3f59ce3b0bfe10))
* **savings:** batch tracker persistence off the request hot path ([#1817](https://github.com/bluish3101/headroom/issues/1817)) ([451b9f0](https://github.com/bluish3101/headroom/commit/451b9f0867f1eb7cf3a1b479f67a4e3106f7e9be))


### Dependencies

* bump @types/node from 22.19.15 to 26.1.1 in /plugins/openclaw ([#1685](https://github.com/bluish3101/headroom/issues/1685)) ([350daeb](https://github.com/bluish3101/headroom/commit/350daeba73edd0954d405fb65580e5ce46bf2be9))
* bump @types/node from 22.20.0 to 26.1.1 in /plugins/opencode ([#1688](https://github.com/bluish3101/headroom/issues/1688)) ([8715195](https://github.com/bluish3101/headroom/commit/87151952eeb85165d14034a1a0f77a70ae824848))
* bump @types/node from 25.5.2 to 26.1.1 in /docs ([#1683](https://github.com/bluish3101/headroom/issues/1683)) ([75fff43](https://github.com/bluish3101/headroom/commit/75fff43eca7901d1e4809c8e7762b974d29f5c14))
* bump fumadocs-typescript from 4.0.14 to 5.3.0 in /docs ([#1684](https://github.com/bluish3101/headroom/issues/1684)) ([e8b66a2](https://github.com/bluish3101/headroom/commit/e8b66a27e1bb7d6452172530ffc024a5f109c49b))
* bump the cargo-minor-patch group across 1 directory with 7 updates ([#1909](https://github.com/bluish3101/headroom/issues/1909)) ([45601d9](https://github.com/bluish3101/headroom/commit/45601d93bcd92f7f66d4c3483d9f4512a10e933c))
* bump the npm-minor-patch group across 4 directories with 18 updates ([#1907](https://github.com/bluish3101/headroom/issues/1907)) ([8872bbc](https://github.com/bluish3101/headroom/commit/8872bbc6a2fa210e9f26d33d1ff8e019954bddd9))


### Code Refactoring

* DRY cache logic, add thread safety, fix Bash exclusion ([#704](https://github.com/bluish3101/headroom/issues/704)) ([e36fccd](https://github.com/bluish3101/headroom/commit/e36fccd8cfe6b963398d3d0fa1637a45bd6421af))
* extract litellm model resolution to shared utility ([ec7d006](https://github.com/bluish3101/headroom/commit/ec7d0065cc5055e504e79cf24f3951e404fe4cb9))
